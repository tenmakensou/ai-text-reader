const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-DdiPePze.js","assets/tts-DZfIWhMZ.js","assets/Reader-uuU0ztTl.js"])))=>i.map(i=>d[i]);
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 h-14 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            "data-ocid": "nav-logo",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary/20 flex items-center justify-center group-hover:bg-primary/30 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Waves, { className: "w-4 h-4 text-primary" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "[&.active]:text-primary", children: ({ isActive }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `text-sm px-3 py-1.5 rounded-md transition-smooth ${isActive ? "text-primary font-medium bg-primary/10" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"}`,
              "data-ocid": "nav-home",
              children: "Home"
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/reader", className: "[&.active]:text-primary", children: ({ isActive }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `text-sm px-3 py-1.5 rounded-md transition-smooth ${isActive ? "text-primary font-medium bg-primary/10" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"}`,
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border/60 py-4 mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
      year,
      ".",
      " ",
...
const Home = reactExports.lazy(() => __vitePreload(() => import("./Home-DdiPePze.js"), true ? __vite__mapDeps([0,1]) : void 0));
const Reader = reactExports.lazy(() => __vitePreload(() => import("./Reader-uuU0ztTl.js"), true ? __vite__mapDeps([2,1]) : void 0));
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    reactExports.Suspense,
    {
      fallback: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-6 space-y-4", children: [
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(J, { attribute: "class", defaultTheme: "dark", enableSystem: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) });
}
