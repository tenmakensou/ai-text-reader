import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, b as createSlot$1, a as cn, d as composeRefs, R as React2, u as useComposedRefs, e as reactDomExports, f as React, g as ReactDOM, B as Button } from "./index-B5_ixe7b.js";
import { S as SUPPORTED_LANGUAGES, D as Download, a as DEFAULT_SETTINGS, B as Badge } from "./tts-DZfIWhMZ.js";
/**
...
function useSpeechSynthesis(options = {}) {
  ...
  const loadVoices = reactExports.useCallback(() => {
    if (!isSupported) return;
    const allVoices = window.speechSynthesis.getVoices();
    const filtered = allVoices.filter(
      (v) => v.lang.toLowerCase().startsWith(langBcp47.split("-")[0].toLowerCase())
    );
    const options2 = filtered.length > 0 ? filtered.map((v, i) => ({
      voice: v,
      label: v.name,
      isDefault: i === 0
...
function Reader() {
  ...
  const [text, setText] = reactExports.useState(savedText);
  const [copied, setCopied] = reactExports.useState(false);
  const [isDownloading, setIsDownloading] = reactExports.useState(false);
  const textareaRef = reactExports.useRef(null);
  const selectedLang = SUPPORTED_LANGUAGES.find((l) => l.code === settings.languageCode) ?? SUPPORTED_LANGUAGES[0];
  const { status, voices, speak, pause, resume, stop, isSupported } = useSpeechSynthesis({
    rate: settings.rate,
  ...
  const handleStop = reactExports.useCallback(() => stop(), [stop]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "main",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border-b border-border px-4 py-3 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/15 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-4 h-4 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-base font-display font-semibold text-foreground leading-tight", children: "AI Text Reader" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground hidden sm:block", children: "Convert text to natural speech" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-0 max-w-2xl mx-auto w-full p-4 pb-6 space-y-3", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Your Text" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-1 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: [
                        ...
                        charPercent > 90 ? "bg-destructive" : charPercent > 70 ? "bg-accent" : "bg-primary"
                      ].join(" "),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Language" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Select,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: SUPPORTED_LANGUAGES.map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: lang.code, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: lang.nativeLabel }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Voice" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Select,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          SelectTrigger,
                          {
                            ...
                            className: "bg-background/60 border-border/60 text-sm h-9",
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Default" })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "__default__", children: "Default Voice" }),
                          voices.filter((v) => v.voice !== null).map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: v.voice.name, children: v.label }, v.voice.name))
                        ] })
                      ]
                    }
                  )
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-7 h-7 fill-current ml-0.5" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: status === "paused" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-6 h-6 fill-current text-foreground ml-0.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "w-6 h-6 fill-current text-foreground" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      "aria-label": "Stop",
                      className: "w-14 h-14 rounded-full bg-muted hover:bg-muted/70 flex items-center justify-center disabled:opacity-40 disabled:cursor-not-allowed active:scale-95 transition-smooth",
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { className: "w-5 h-5 fill-current text-foreground" })
                    }
                  )
                ] }),
                !isSupported && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center gap-2 text-destructive text-xs bg-destructive/10 rounded-lg px-3 py-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-3.5 h-3.5 flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Speech synthesis is not supported in your browser." })
                ] })
              ]
            }
          ),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Speed" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono font-semibold text-primary bg-primary/10 px-2 py-0.5 rounded", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground/60 font-mono", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "0.5x" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "1.0x" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "1.5x" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "2.0x" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Pitch" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono font-semibold text-primary bg-primary/10 px-2 py-0.5 rounded", children: settings.pitch.toFixed(1) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Slider,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground/60 font-mono", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "1.5" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "2.0" })
                  ] })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-slide-up", style: { animationDelay: "240ms" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground mt-1.5", children: "Saves as WebM audio • Works best in Chrome / Edge" })
          ] })
        ] })
      ]
    }
